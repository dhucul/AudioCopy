...
void PrintHelpMenu() {
	...
	PrintEntry({ "4. Quality Scan (C1/C2/CU Graphs)",
		...
		"   but not Q-Check. Use option 6 (BLER Scan) on those drives instead.",
		"True C1/C2/CU error rate measurement on supported Plextor drives." });

	PrintEntry({ "5. C2 Error Scan",
	...
	PrintEntry({ "6. BLER Scan (Detailed)",
	...
	PrintEntry({ "7. Disc Rot Detection",
	...
	PrintEntry({ "8. Generate Surface Map",
	...
	PrintEntry({ "9. Multi-Pass Verification",
	...
	PrintEntry({ "10. Compare Disc CRCs (Original vs. Copy)",
	...
	PrintEntry({ "11. Audio Content Analysis",
	...
	PrintEntry({ "12. Disc Fingerprint (CDDB/MusicBrainz/AccurateRip IDs)",
	...
	PrintEntry({ "14. Subchannel Integrity Check",
	...
	PrintEntry({ "15. Verify Subchannel Burn Status",
	...
	PrintEntry({ "16. Copy-Protection Check",
	...
	PrintEntry({ "17. Drive Capabilities",
	...
	PrintEntry({ "18. Drive Offset Detection",
	...
	PrintEntry({ "19. C2 Validation Test",
	...
	PrintEntry({ "20. Speed Comparison Test",
	...
	PrintEntry({ "21. Seek Time Analysis",
	...
	PrintEntry({ "22. Chipset Identification",
	...
	PrintEntry({ "23. Disc Balance Check",
	...
	PrintEntry({ "25. Check for Updates",
	...
	PrintEntry({ "26. Help (Test Descriptions)",
