...
void PrintHelpMenu() {
	...
	PrintEntry({ "5. Quality Scan (C1/C2/CU Graphs)",
		...
		"   but not Q-Check. Use option 7 (BLER Scan) on those drives instead.",
		"True C1/C2/CU error rate measurement on supported Plextor drives." });

	PrintEntry({ "6. C2 Error Scan",
	...
	PrintEntry({ "7. BLER Scan (Detailed)",
	...
	PrintEntry({ "8. Disc Rot Detection",
	...
	PrintEntry({ "9. Generate Surface Map",
	...
	PrintEntry({ "10. Multi-Pass Verification",
	...
	PrintEntry({ "11. Compare Disc CRCs (Original vs. Copy)",
	...
	PrintEntry({ "12. Audio Content Analysis",
	...
	PrintEntry({ "13. Disc Fingerprint (CDDB/MusicBrainz/AccurateRip IDs)",
	...
	PrintEntry({ "15. Subchannel Integrity Check",
	...
	PrintEntry({ "16. Verify Subchannel Burn Status",
	...
	PrintEntry({ "17. Copy-Protection Check",
	...
	PrintEntry({ "18. Drive Capabilities",
	...
	PrintEntry({ "19. Drive Offset Detection",
	...
	PrintEntry({ "20. C2 Validation Test",
	...
	PrintEntry({ "21. Speed Comparison Test",
	...
	PrintEntry({ "22. Seek Time Analysis",
	...
	PrintEntry({ "23. Chipset Identification",
	...
	PrintEntry({ "24. Disc Balance Check",
	...
	PrintEntry({ "26. Check for Updates",
	...
	PrintEntry({ "27. Help (Test Descriptions)",
	...
	PrintEntry({ "28. Pioneer CD Check (Audio Quality)",
	...
	PrintEntry({ "29. Jitter / Beta Scan (LiteOn)",
