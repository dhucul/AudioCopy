...
| 5 | Disc Quality | Quality scan (C1/C2/CU graphs) |
| 6 | Disc Quality | C2 error scan |
| 7 | Disc Quality | BLER scan (detailed) |
| 8 | Disc Quality | Disc rot detection |
| 9 | Disc Quality | Generate surface map |
| 10 | Disc Quality | Multi-pass verification |
| 11 | Disc Quality | Compare disc CRCs (original vs. copy) |
| 12 | Disc Info | Audio content analysis |
| 13 | Disc Info | Disc fingerprint (CDDB/MusicBrainz/AccurateRip IDs) |
| 14 | Disc Info | Lead area check |
| 15 | Disc Info | Subchannel integrity check |
| 16 | Disc Info | Verify subchannel burn status |
| 17 | Disc Info | Copy-protection check |
| 18 | Drive | Drive capabilities |
| 19 | Drive | Drive offset detection |
| 20 | Drive | C2 validation test |
| 21 | Drive | Speed comparison test |
| 22 | Drive | Seek time analysis |
| 23 | Drive | Chipset identification |
| 24 | Drive | Disc balance check |
| 25 | Utility | Rescan disc |
| 26 | Utility | Check for updates |
| 27 | Utility | Help (test descriptions) |
| 28 | Utility | Exit |
...
If neither command set is supported by the drive, the scan reports the incompatibility and suggests using the BLER scan (option 7) instead.
...
If you are unsure whether a disc has subchannel content worth preserving, run **option 16 — Verify Subchannel Burn Status** before ripping. This samples sectors across the disc and reports:
...
After the burn, run **option 11 — Compare disc CRCs (Original vs. Copy)** to confirm the detected sample offset is zero. If it's non-zero, that's the residual you should add to the next burn's compensation value.
