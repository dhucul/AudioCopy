...
namespace Console {
	...
	namespace Theme {
		constexpr int BgR = 25,  BgG = 25,  BgB = 25;         // matte dark — neutral charcoal
		constexpr int FgR = 210, FgG = 210, FgB = 210;         // soft white — neutral, easy on eyes
		constexpr int CyanR = 80,  CyanG = 200, CyanB = 200;   // true cyan — no green shift needed on neutral bg
		constexpr int GreenR = 80, GreenG = 200, GreenB = 120;  // soft mint — toned down, easy on eyes
		constexpr int RedR = 255,  RedG = 90,   RedB = 90;      // coral red — warm pop on dark bg
		constexpr int YellowR = 255, YellowG = 210, YellowB = 60; // bright gold — high contrast on dark bg
		constexpr int WhiteR = 255, WhiteG = 255, WhiteB = 255;
		constexpr int DimR = 130,  DimG = 130,  DimB = 130;     // neutral gray — visible but subdued
	}
